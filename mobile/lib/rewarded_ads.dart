...
class RewardedAds {
  ...
  /// Google's public test unit. A build with no AdMob account still works, and
  /// still fills, so the reward flow can be exercised end to end. Replaced at
  /// build time by --dart-define=ADMOB_REWARDED_UNIT=ca-app-pub-…/…
  ...
  /// True while a real AdMob unit has not been configured. The screen says so,
  /// rather than letting a tester think the rewards are live.
