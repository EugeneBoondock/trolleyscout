...
export const ONLINE_STORE_SOURCES: Readonly<Record<string, readonly OnlineStoreSource[]>> = {
  ...
  ZW: [
    ...
    // Official storefronts and sale pages verified on 27 July 2026.
    store('Groceries', 'PrevailMart', 'https://www.prevailmart.com/'),
    store('Groceries', 'From Me', 'https://www.fromme.co.zw/'),
    store('General', 'SkipQ', 'https://skipq.co.zw/'),
    store('General', 'TopDeals Zimbabwe', 'https://www.topdeals.co.zw/'),
    store('General', 'Shop Save Zimbabwe', 'https://shopsave.co.zw/'),
    store('General', 'Zim & More', 'https://www.zimandmore.co.zw/'),
    ...
    store('Tech', 'ZIMONLINE', 'https://www.onlinezim.co.zw/'),
    store('Tech', 'ElectroMaster Zimbabwe', 'https://electromaster.co.zw/'),
    store('General', 'Bandauko', 'https://bandauko.co.zw/'),
    store('Home', 'Bhiks Home Stores', 'https://bhikshomestore.co.zw/'),
    store('Home', 'House & Home Zimbabwe', 'https://houseandhome.co.zw/'),
    store('Home', 'Station Furnishers', 'https://www.stationfurnishers.com/'),
    store('Home', 'Wisrod Shop', 'https://wisrodshop.com/'),
    store('Home', 'Modern Furnishers', 'https://www.modern.co.zw/'),
